...
const Finance = () => {
  ...
  const currentItems = financeData.slice(indexOfFirstItem, indexOfLastItem);
  const totalPages = Math.ceil(financeData.length / 10);

  const handleShowAddFinance = (e) => {
    e.stopPropagation();
    const addFinanceDiv = document.getElementById("showAddFinance");
    addFinanceDiv.classList.replace("hidden", "block");
  };

  const handleShowFilter = (e) => {
    e.stopPropagation();
    const financeFilter = document.getElementById("financeFilter");
    financeFilter.classList.replace("hidden", "block");
  };
  ...
  const hideShowAddFinance = () => {
    const addFinanceDiv = document.getElementById("showAddFinance");
    addFinanceDiv.classList.replace("block", "hidden");
  };
  const handleHildeFilter = () => {
    const addFinanceDiv = document.getElementById("financeFilter");
    addFinanceDiv.classList.replace("block", "hidden");
  };
  return (
    <div className="w-full flex mt-16 justify-end bg-gray-100 ">
      <div
        ...
        className="md:w-[93%] text-black  lg:w-[80%] px-4 my-5  items-end b"
      >
        <h1 className="roboto-bold text-lg font-extrabold">Finance</h1>
        ...
        <section className="flex justify-between my-8 items-center">
          <div className="flex items-center justify-between px-5 rounded-xl bg-white w-[30%] py-1.5 ">
            ...
            >
              <g clipPath="url(#clip0_450_92)">
                <path
                  d="M31.444 29.5205L20.7664 21.6031C21.8164 19.9062 22.423 17.9102 22.423 15.7758C22.423 14.4399 22.1876 13.1328 21.7233 11.8906C21.4574 11.1793 20.6651 10.8181 19.9539 11.0841C19.2426 11.3499 18.8815 12.1421 19.1474 12.8534C19.4961 13.7866 19.673 14.7699 19.673 15.7758C19.673 20.408 15.8772 24.1766 11.2115 24.1766C6.54581 24.1766 2.75 20.408 2.75 15.7758C2.75 11.1436 6.54581 7.375 11.2115 7.375C12.5029 7.375 13.7418 7.65588 14.8939 8.20975C15.5784 8.53881 16.3999 8.25069 16.7289 7.56637C17.058 6.882 16.7699 6.06044 16.0856 5.73138C14.5586 4.99725 12.9187 4.625 11.2115 4.625C5.02944 4.625 0 9.62725 0 15.7758C0 21.9244 5.02944 26.9266 11.2115 26.9266C14.2556 26.9266 17.0196 25.7132 19.0419 23.7479L29.8061 31.7295C30.0522 31.9121 30.3393 32.0001 30.6239 32.0001C31.0445 32.0001 31.4597 31.8078 31.7295 31.444C32.1818 30.834 32.0539 29.9728 31.444 29.5205Z"
                  fill="#7A8699"
                />
                <path
                  d="M18.9395 10.3691C19.6988 10.3691 20.3145 9.75352 20.3145 8.99414C20.3145 8.23475 19.6988 7.61914 18.9395 7.61914C18.1801 7.61914 17.5645 8.23475 17.5645 8.99414C17.5645 9.75352 18.1801 10.3691 18.9395 10.3691Z"
                  fill="#7A8699"
                />
              </g>
              <defs>
          ...
          <div className="flex w-2/5 gap-x-3 items-center ">
            <div className="flex bg-[#0E2238] w-1/3 whitespace-nowrap px-2 text-xs items-center gap-x-2 py-1.5 rounded-md text-white">
              <svg
                width="24"
                height="24"
                viewBox="0 0 24 24"
            ...
            <div
              ...
              className="flex roboto-bold items-center bg-white w-[30%] justify-center gap-x-2 py-1 rounded-md"
            >
              <svg
                width="18"
                height="18"
              ...
              <p className="roboto-bold">Filters</p>
            </div>
            <div
              onClick={handleShowAddFinance}
              className="bg-[#0E2238] flex text-white items-center rounded-md py-1.5 justify-center gap-x-2 px-5"
            >
              <svg
                width="19"
                height="18"
            ...
            >
              <path
                d="M2.00033 3.79167C3.04737 3.79167 3.89616 2.94287 3.89616 1.89583C3.89616 0.848793 3.04737 0 2.00033 0C0.953286 0 0.104492 0.848793 0.104492 1.89583C0.104492 2.94287 0.953286 3.79167 2.00033 3.79167Z"
                fill="#9EA9B4"
              />
              <path
                d="M2.00033 8.89714C3.04737 8.89714 3.89616 8.04834 3.89616 7.0013C3.89616 5.95426 3.04737 5.10547 2.00033 5.10547C0.953286 5.10547 0.104492 5.95426 0.104492 7.0013C0.104492 8.04834 0.953286 8.89714 2.00033 8.89714Z"
                fill="#9EA9B4"
              />
              <path
                d="M2.00033 13.9987C3.04737 13.9987 3.89616 13.1499 3.89616 12.1029C3.89616 11.0558 3.04737 10.207 2.00033 10.207C0.953286 10.207 0.104492 11.0558 0.104492 12.1029C0.104492 13.1499 0.953286 13.9987 2.00033 13.9987Z"
                fill="#9EA9B4"
              />
            </svg>
          </div>
        ...
        <section className="my-8">
          <table className="w-full  border-collapse border border-slate-900    poppins-regular ">
            <thead className="text-start text-[#404040] inter-medium bg-[#D9D9D9] ">
              <tr className="">
                <th className="rounded-ss-lg  border py-7"></th>
                <th className="pl-8  text-start">ID</th>
                <th className="pl-8  ">Date Published</th>
                <th className="px-6  ">Income</th>
                <th className="px-6  ">Pending</th>
                <th className="px-4  ">Total Amount</th>
                <th className="px-4  first-line:text-start rounded-se-lg "></th>
              </tr>
            </thead>
            <tbody className="bg-white inter-regular last:rounded-b-lg">
              {currentItems?.length
                ? currentItems.map((data, index) => {
                    return (
                      <tr key={index}>
                        <td className="py-5 border border-gray-100 pl-5">
                          <input
                            type="checkbox"
                            className="focus:ring-0 rounded-sm"
                          ></input>
                        </td>
                        <td className="py-5 text-center border border-gray-100 ">
                          {data.id}
                        </td>
                        <td className="py-5 text-center border border-gray-100 ">
                          {data.date}
                        ...
                        <td className="border text-center relative pl-5">
                          <svg
                          ...
                          {showDropdown[index] ? (
                            <ul className="absolute border bg-white  w-40 right-[47px] top-10 text-start   text-black  text-sm roboto-medium  rounded-md  px-2">
                              <li
                                onClick={(e) => handleShowView(e, index)}
                                className="my-1 hover:bg-gray-200 p-1 hover:rounded-md"
                              >
                                View
                              </li>
                              <li className="my-1 hover:bg-gray-200 p-1 hover:rounded-md">
                                Send Email
                              </li>
                              <li className="my-1 hover:bg-gray-200 p-1 hover:rounded-md">
                                Print
                          ...
                          {showView[index] ? (
                            <ul className="absolute  bg-[#0E2238] w-96 right-[47px] top-10 text-start   text-white text-sm roboto-medium  rounded-sm  p-4">
                              <li className="text-xl">View</li>
                              <li className="my-2 inter-bold">
                                ID:
                                <span className="inter-medium"> #001234</span>
                              </li>
                              <li className="my-2 inter-bold">
                                Amount:{" "}
                                <span className="inter-medium">81000</span>
                              </li>
                              <li className="my-2 inter-bold">Tax:</li>
                              <li className="my-2 inter-bold">
                                Tds: <span className="inter-medium">3670</span>
                              </li>
                              <li className="my-2 inter-bold">
                                Total Amount:
                                <span className="inter-medium">3670</span>
                              </li>
                              <li className="my-2 inter-bold">
                                Date:{" "}
                              ...
                              <li className="my-2 inter-bold">
                                Time:{" "}
                                <span className="inter-medium">20:13 PM</span>
                              </li>
                            </ul>
                          ) : null}
                        </td>
      ...
      <div id="showAddFinance" className="hidden">
        <AddFinance />
      </div>
      <div id="financeFilter" className="hidden">
        <FinanceFilter />
      </div>
    </div>
  );
