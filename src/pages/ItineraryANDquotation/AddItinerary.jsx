...
const AddItinerary = () => {
  const datepicker1 = useRef(null);
  const datepicker2 = useRef(null);
  useEffect(() => {
    const $datepickerEl = document.getElementById("datepicker-orientation1");
    const $datepickerE2 = document.getElementById("datepicker-orientation2");
    const options = {
    ...
    const instanceOptions1 = {
      id: "datepicker-orientation1",
      override: true,
    };
    const instanceOptions2 = {
      id: "datepicker-orientation2",
      override: true,
    };

    datepicker1.current = new Datepicker(
      $datepickerEl,
      options,
      instanceOptions1
    );
    datepicker2.current = new Datepicker(
      $datepickerE2,
      options,
      instanceOptions2
    );
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const date = new Date(datepicker1.current?.getDate());
